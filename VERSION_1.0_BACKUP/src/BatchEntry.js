...
function BatchTaskForm({ addTask }) {
  ...
  const tableHeaders = [
    'Project', 'Description', 'Deadline', 'Responsible (comma-separated)', 'Recurring', 'Interval (months)', 'Final Year', 'Notes', ''
  ];
  ...
  const handleTablePaste = (e) => {
    ...
    const fieldMap = ['projectName', 'description', 'deadline', 'responsibleParty', 'recurring', 'frequency', 'finalYear', 'notes'];
