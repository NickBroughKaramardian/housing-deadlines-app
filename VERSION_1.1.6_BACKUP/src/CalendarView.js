...
export default function CalendarView({ tasks, handleEditClick, handleToggleCompleted, handleToggleUrgent, handleDeleteTask, handleDocumentLinkClick, parseDeadlineDate }) {
                      ...
                      <button 
                        ...
                        className={`w-8 h-8 flex items-center justify-center rounded-full transition-colors duration-200 ${
                          task.documentLink 
                            ...
                            : 'bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-200 hover:bg-purple-200 dark:hover:bg-purple-900/50'
                        }`}
