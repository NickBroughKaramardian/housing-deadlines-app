                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      {(userProfile.role === ROLES.DEVELOPER || userProfile.role === ROLES.OWNER) && (
                        <div className="mt-2">
                          <div className="text-xs font-semibold text-gray-700 dark:text-gray-300 mb-2">Departments</div>
                          <div className="flex flex-wrap gap-2">
                            {Object.values(DEPARTMENTS).map(deptId => {
                              const active = Array.isArray(user.departments) && user.departments.includes(deptId);
                                ...
                                <button
                                  ...
                                  onClick={async () => {
                                    try {
                                      ...
                                      const next = active ? current.filter(d => d !== deptId) : Array.from(new Set([...current, deptId]));
