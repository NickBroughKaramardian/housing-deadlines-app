      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden bg-white border-b border-gray-100 shadow-sm">
          <div className="flex flex-col p-2 gap-1">
            ...
            {/* Deadlines Dropdown */}
            <div className="relative view-deadlines-dropdown" onMouseLeave={() => setViewDeadlinesOpen(false)}>
              <button 
            ...
            {/* Admin Dropdown */}
            <div className="relative admin-dropdown" onMouseLeave={() => setAdminMenuOpen(false)}>
              <button 
      ...
      <div className="hidden lg:flex items-center justify-between px-4 py-4 bg-white border-b border-gray-100 shadow-sm sticky top-0 z-20">
        ...
        <div className="flex items-center gap-4 w-full max-w-7xl mx-auto">
          <div className="flex flex-1 gap-2 w-full">
            ...
            {/* Deadlines Dropdown */}
            <div className="relative view-deadlines-dropdown flex-1" onMouseLeave={() => setViewDeadlinesOpen(false)}>
              <button 
                onClick={() => setViewDeadlinesOpen(!viewDeadlinesOpen)}
            ...
            {/* Admin Dropdown */}
            <div className="relative admin-dropdown flex-1" onMouseLeave={() => setAdminMenuOpen(false)}>
              <button 
                onClick={() => setAdminMenuOpen(!adminMenuOpen)}
                className={`w-full px-4 py-2 rounded text-center flex items-center justify-center gap-2 ${
                  ['data', 'users', 'settings'].includes(activeTab) 
