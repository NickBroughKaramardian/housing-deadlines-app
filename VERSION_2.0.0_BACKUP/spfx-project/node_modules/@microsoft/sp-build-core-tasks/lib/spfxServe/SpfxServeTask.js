...
class SpfxServeTask extends ServeTask_1.ServeTask {
    ...
    _getPlaceHolderDomainName(placeHolderDomainName) {
        ...
        if ((placeHolderDomainName === null || placeHolderDomainName === void 0 ? void 0 : placeHolderDomainName.includes(TENANT_DOMAIN_PLACEHOLDER)) && openBrowser) {
            ...
            return placeHolderDomainName.replace(TENANT_DOMAIN_PLACEHOLDER, process.env.SPFX_SERVE_TENANT_DOMAIN);
        }
        else {
            return placeHolderDomainName;
        }
