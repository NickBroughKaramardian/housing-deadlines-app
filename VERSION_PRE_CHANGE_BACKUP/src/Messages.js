...
export default function Messages() {
  ...
  // Show loading overlay for half a second regardless of actual loading state
  ...
  return (
    <div className="max-w-6xl mx-auto min-h-[600px] relative">
      ...
      {/* Main Content */}
      <div className={showLoadingOverlay ? 'opacity-0' : 'opacity-100 transition-opacity duration-300'}>
      {/* Horizontal Tabs */}
