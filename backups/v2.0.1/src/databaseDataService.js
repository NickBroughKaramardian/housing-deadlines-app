...
class DatabaseDataService {
  ...
  async getAllTasks() {
    ...
    try {
      const tasks = (await microsoftDataService.tasks.getAll()).filter(task => task != null);
  ...
  async updateTask(taskId, updates) {
    try {
      console.log('DatabaseDataService: Updating task', taskId, 'with', updates);
      ...
      console.log('DatabaseDataService: Task updated successfully');
      return true;
    } catch (error) {
      console.error('DatabaseDataService: Error updating task:', error);
      throw error;
    }
  }
  ...
  async deleteTask(taskId) {
    try {
      console.log('DatabaseDataService: Deleting task', taskId);
      ...
      console.log('DatabaseDataService: Task deleted successfully');
      return true;
    } catch (error) {
      console.error('DatabaseDataService: Error deleting task:', error);
      throw error;
    }
  }
}
