...
import { EntityMarker } from '@rushstack/webpack4-localization-plugin/lib/utilities/EntityMarker';
...
import { ILocalizedStrings } from '@rushstack/webpack4-localization-plugin';
...
import { IWebpackConfigurationWithDevServer } from '@rushstack/heft-webpack4-plugin/lib/index';
 ...
 * @internal
 */
declare class CustomizeWebpackConfigurationPlugin implements IHeftPlugin<_ICustomizeWebpackConfigurationPluginOptions> {
    readonly pluginName: string;
    apply(heftSession: HeftSession, heftConfiguration: HeftConfiguration, options: _ICustomizeWebpackConfigurationPluginOptions): void;
 ...
 * That's why we are using PascalCase here insted of camelCase.
 */
...
export declare interface ISpfxHeftPluginAccessor {
    ...
    spfxWebpackServeConfiguration: IWebpackServeConfigurationPluginAccessor;
}
...
export declare class _ManifestsFileBuilder {
    ...
    buildManifestsJsAsync(manifestsArray: IClientSideComponentManifest[], outputFilePath: string, azurePathOverride: string | undefined, manifestsJsFileMetadata: _IManifestsFileMetadata | undefined): Promise<void>;
...
declare namespace PluginNames {
    export {
        DevDeployPlugin,
        SpfxHeftPlugin_2 as SpfxHeftPlugin,
 ...
 * @public
 */
declare const SpfxHeftPlugin_2: 'spfx-heft-plugin';
