...
export default function GanttChart({ tasks, handleEditClick, handleToggleCompleted, handleToggleUrgent, handleDeleteTask, parseDeadlineDate }) {
            ...
            <div className="space-y-4">
              {taskPositions.map((task, index) => {
                ...
                return (
                  <div 
                    key={task.id || index} 
                    className={`group relative overflow-hidden rounded-xl border ${status.border} ${status.bg} transition-all duration-300 hover:shadow-lg hover:scale-[1.02] hover:border-opacity-80 cursor-pointer`}
