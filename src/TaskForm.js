        ...
        {recurring && (
          <div className="flex gap-4">
            ...
            <input
              ...
              className="border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-theme-primary focus:border-transparent text-gray-800 flex-1"
            />
          </div>
        )}
        <button
