...
export const sharePointService = {
  ...
  // Get organization users - disabled to prevent 404 errors
  getUsers: async () => {
    try {
      // Disabled /users API call to prevent 404 errors
      console.log('GraphService: Using empty users array to prevent API errors');
      return [];
    } catch (error) {
  ...
  // Get enterprise users from Microsoft Graph - disabled to prevent 404 errors
  getEnterpriseUsers: async () => {
    try {
      // Disabled /users API call to prevent 404 errors
      console.log('GraphService: Using empty enterprise users array to prevent API errors');
      return [];
    } catch (error) {
